...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View(); //you can also leave it empty instead of writing ShowSearchForm
        ...
        {
            //return "You entered " + SearchPhrase; //you can also leave it empty instead of writing ShowSearchForm
